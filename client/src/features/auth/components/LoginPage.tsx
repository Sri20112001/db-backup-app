  ...
  return (
    <div className="min-h-screen bg-[#f9f9ff] flex items-center justify-center px-4">
      <div className="w-full max-w-[420px] bg-[#ffffff] rounded-xl border border-[#e9edff] shadow-[0_4px_24px_rgba(20,27,43,0.08)] p-8">
        ...
        <h2 className="text-[18px] font-semibold text-[#141b2b] mb-1">Sign in</h2>
        <p className="text-[13px] text-[#737686] mb-6">Protecting your business data</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="block text-[13px] font-medium text-[#434655] mb-1.5" htmlFor="email">
              Email address
            </label>
            <input
              id="email"
          ...
          <div>
            <label className="block text-[13px] font-medium text-[#434655] mb-1.5" htmlFor="password">
              Password
            </label>
